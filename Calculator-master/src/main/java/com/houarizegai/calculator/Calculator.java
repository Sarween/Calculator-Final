...
private static final String formula1 = "[-]?[\\d]+[.][0]*";
...
public class Calculator {
    ...
    */
    ...
    public Calculator() {
        ...
        window.setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE); // Close button clicked? = End The process
